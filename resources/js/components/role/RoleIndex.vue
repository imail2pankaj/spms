<template>
              ...
              <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-2 px-2 text-center whitespace-nowrap">
                  <div class="flex item-center justify-center">
                    ...
                    <button
                      type="button"
                      @click="item_id = item.id; togglePopup();"
                      class="no-underline w-4 mr-2 transform hover:text-purple-500 hover:scale-110 ">
                      <delete-icon />
                    </button>
                  </div>
  ...
  <app-confirm-delete
    ...
    @deleteRecordEvent="destroyRole(item_id)"
    @close="togglePopup"
  ></app-confirm-delete>
</template>
...
export default {
  setup(props) {
    ...
    const { roles, pagination, getRoles, deleteRole } = useRoles();
