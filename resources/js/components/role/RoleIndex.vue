<template>
  <div class="flex justify-between mb-2">
    ...
    <router-link :to="{name:'role.create'}" class="p-2 transition-colors duration-700 transform bg-indigo-500 hover:bg-blue-400 text-gray-100 text-sm rounded-lg focus:border-4 border-indigo-300">
          Add
    </router-link>
