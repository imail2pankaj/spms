      ...
      <div class="bg-white border-b border-gray-200">
          ...
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6 mb-6">
              <div class="">
                  <label for="first_name" class="input-form-label">First Name</label>
              ...
              <div class="">
                  <label for="last_name" class="input-form-label">Last Name</label>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6 mb-6">
              ...
              <div class="">
                <label for="confirm_password" class="input-form-label">Confirm Password</label>
                <input type="password" placeholder="Confirm Password" v-model="form.confirm_password" id="confirm_password" name="confirm_password" class="input-form-control" required >
                <span v-if="errors.confirm_password">{{errors.confirm_password}}</span>
              </div>
              <div class=" ">
                  <label for="roles" class="input-form-label">Role</label>
              ...
              <div class="">
                ...
                <input type="date" v-model="form.join_date" id="join_date" name="join_date" class="input-form-control" placeholder="Joining Date" required >
                <span v-if="errors.join_date">{{errors.join_date}}</span>
              </div>

              <div class="">
                <label for="resign_date" class="input-form-label">Resign Date</label>
                <input type="date" v-model="form.resign_date" id="resign_date" name="resign_date" class="input-form-control" placeholder="Resign Date" required >
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6 mb-6">
              ...
              <div class="">
                  <label for="phone_number" class="input-form-label">Phone Number</label>
              ...
              <div class="">
                  ...
                  <input type="tel" placeholder="Emergency Phone Number" v-model="form.emergency_phone_number" id="emergency_phone_number" name="emergency_phone_number" class="input-form-control" required >
              ...
              <div class="">
                  <label for="city" class="input-form-label">City</label>
              ...
              <div class="">
                <label for="state" class="input-form-label">State</label>
              ...
              <div class="">
                <label for="country" class="input-form-label">Country</label>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6 mb-6">
              ...
              <div class="">
                  <label for="user_status" class="input-form-label">Status <span class="text-red-900">*</span></label>
